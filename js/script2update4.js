	  ...
	  function showDetail(){
		...
		query.find({
			success: function(results){
			    ...
			    document.getElementById("status45").checked = status45;
			    document.getElementById("status46").checked = status46;
			    document.getElementById("status47").checked = status47;
			    document.getElementById("status48").checked = status48;
			    document.getElementById("status49").checked = status49;
			    document.getElementById("status50").checked = status50;
